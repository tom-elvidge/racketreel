...
import 'create_match/presentation/bloc/create_match_cubit.dart' as _i15;
import 'feed/data/feed_item_repository.dart' as _i17;
import 'feed/domain/i_feed_item_repository.dart' as _i16;
import 'feed/presentation/bloc/feed_bloc.dart' as _i21;
import 'match/data/i_state_history_data_source.dart' as _i8;
import 'match/data/match_state_repository.dart' as _i19;
import 'match/data/state_history_data_source.dart' as _i9;
import 'match/data/summary_repository.dart' as _i13;
import 'match/domain/i_match_state_repository.dart' as _i18;
import 'match/domain/i_summary_repository.dart' as _i12;
import 'match/presentation/bloc/match_bloc.dart' as _i20;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i15.CreateMatchFormatCubit>(
      () => _i15.CreateMatchFormatCubit(get<_i3.IMatchCreatorService>()));
  gh.factory<_i16.IFeedItemRepository>(() =>
      _i17.FeedItemRepository(dataSource: get<_i10.ISummaryDataSource>()));
  gh.factory<_i18.IMatchStateRepository>(() => _i19.MatchStateRepository(
      dataSource: get<_i8.IStateHistoryDataSource>()));
  gh.factory<_i20.MatchBloc>(() => _i20.MatchBloc(
        get<_i18.IMatchStateRepository>(),
        get<_i12.ISummaryRepository>(),
      ));
  gh.factory<_i21.FeedBloc>(
      () => _i21.FeedBloc(get<_i16.IFeedItemRepository>()));
  return get;
}
